...
<head>
  ...
  <div class="container-fluid" style="padding-top:35px; padding-bottom:35px;">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="rec_pat.php">Patient Records</a></li>
...
<div id="header" class="container-fluid"	style="padding-top: 12px; padding-bottom: 12px; text-align:center;">
    <h1 style="margin-bottom:0;">Patient Records</h1>
...
function validateForm()
{
  ...
  var hc=document.form1.healthcardnum.value;
  //if(fn=="" && ln!="") {	  
...
<div class="container-fluid" style="padding-bottom:0;">
  ...
  <div class="row">
    ...
    <div class="row">
	  <div class="col-md-5"></div>
    <div class="col-md-1">Health Card #</div>
    <div class="col-md-1"><label for="healthcardnum"></label>
      <input type="text" name="healthcardnum" id="healthcardnum" value="<?PHP echo $_REQUEST['healthcardnum']; ?>" /></div>
		<div class="col-md-5"></div>
  </div>
  <div class="row">
	  <div class="col-md-5"></div>
...
<div class="container-fluid" style="padding-bottom:0;">
  ...
  <div class="row">
    ...
    <div class="col-md-1">Health Card #</div>
    <div class="col-md-1"><label for="healthcardnum"></label>
      <input type="text" name="healthcardnum" id="healthcardnum" value="" /></div>
		<div class="col-md-5"></div>
  </div>
  <div class="row">
	  <div class="col-md-5"></div>
...
$result = mysqli_query($mysqlic, "SELECT * FROM patient_info ORDER BY patient_info.lastname ASC");
...
echo "<div class='col-md-1'>Health Card Number</div>";
echo "<div class='col-md-2'></div>";
echo "</div>";
while($row=mysqli_fetch_array($result))
{ echo "<div class='row'>";
$idn=$row['id'];$first=$row['firstname'];$last=$row['lastname'];$addr=$row['address'];$phone=$row['phonenum'];$health=$row['healthcardnum'];
echo "<div class='col-md-2'></div>";
echo "<div class='col-md-1'>".$row['id']."</div>";
 echo "<div class='col-md-1'>".$row['firstname']." </div>";
   ...
   echo "<div class='col-md-1'>".$row['healthcardnum']."</div>";
   echo "<div class='col-md-1'><a href='delete.php?id=$idn'>Delete</a></div>";
   echo "<div class='col-md-1'><a href='rec_pat.php?id=$idn&action=edit&firstname=$first&lastname=$last&address=$addr&phonenum=$phone&healthcardnum=$health'>Edit</a></div>";
	 echo "<div class='col-md-2'></div>";
	echo "</div>";
	}
echo "</div>";
